    ...
    setTimeout(() => {
      ...
      if (filters.query) {
        filtered = filtered.filter(r => 
          r.label.toLowerCase().includes(filters.query.toLowerCase()) ||
          r.ingredientLines.some(i => i.toLowerCase().includes(filters.query.toLowerCase()))
        );
      }
      
      if (filters.cuisineType) {
        filtered = filtered.filter(r => 
          r.cuisineType.some(c => c.toLowerCase().includes(filters.cuisineType!.toLowerCase()))
        );
      }
      
      if (filters.mealType) {
        filtered = filtered.filter(r => 
          r.mealType.some(m => m.toLowerCase() === filters.mealType!.toLowerCase())
        );
      }
